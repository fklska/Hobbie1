...
### Light update 0.0.3
Добалены тени и эффект облаков, динамическое освещение. "Время" считается через нормализованную функцию синуса `(sin(delta) + 1) / 2`, где 1 - это ясный полдень, а 0 темнаяа ночь
